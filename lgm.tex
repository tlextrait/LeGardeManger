...
\subsection*{Ingredients}
	\begin{itemize}
		...
		\item 280g flour
		\item 80g sugar
		\item 100g rum (optional)
		\item 3 eggs
		\item Butter for the pan
		\item Vanilla extract, orange blossom water... (optional)
	\end{itemize}
\subsection*{Procedure}
	\begin{enumerate}
		\item Mix the eggs, flour and sugar.
		\item Optionally replace 100g of the milk by 100g of rum.
		\item Pour 1/3 of the milk into the batter.
		\item Mix and pour the rest of the milk and rum while mixing.
		\item Add aroma if desired (vanilla extract, orange flower...).
		\item Pre-heat the pan, then butter lightly and fry the crepe, buttering the pan between each crepe.
	\end{enumerate}
\subsection*{Notes}
	\begin{itemize}
		\item Use only whole milk.
		\item Butter may be substituted with margarine.
		\item Some cane or brown sugar can give some flavor.
		...
		\item If using rum, it should be dark rum. Recommendations: Grand Marnier, Cointreau, Negrita.
	\end{itemize}
\newpage
