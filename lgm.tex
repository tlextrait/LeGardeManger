...
\subsection*{Procedure}
	\begin{enumerate}
		...
		\item When the milk comes to a boil, remove from stove and let it cool just until it is below 60C (140F).
		\item Pour the milk into the eggs and mix.
		\item Preheat the oven at 120C (250F).
...
\subsection*{Procedure}
	\begin{enumerate}
		...
		\item Flip the cr\^{e}pe when ready and cook another few seconds.
		\item Butter the pan before each new cr\^{e}pe.
	\end{enumerate}
\subsection*{Notes}
	\begin{itemize}
		...
		\item A good cr\^{e}pe should be yellowish and have brown dots on one side.
		...
		\item A trick to know that the first side is cooked is to wait until the very edge of the cr\^{e}pe starts becoming brown.
	\end{itemize}
\subsection*{Troubleshooting}
	\begin{itemize}
		\item If tiny holes appear in the cr\^{e}pe, it means the pan is too hot.
		\item If there are no bubbles, it means the pan is too cold.
		\item The first cr\^{e}pe is usually spoiled, undercooked or overcooked.
		\item The two sides of the cr\^{e}pe should look different.
	\end{itemize}
\newpage
...
\subsection*{Procedure}
	\begin{enumerate}
		...
		\item Preheat oven to 180C (355F) and let the batter rest in the molds for another half hour.
...
\subsection*{Procedure}
	\begin{enumerate}
		...
		\item Preheat the oven to 210C (410F).
